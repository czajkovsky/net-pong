...
SRCS=app.cpp Server.cpp Client.cpp IThread.cpp Mutex.cpp SharedMemory.cpp GameEngine.cpp Ball.cpp
HEADERS=app.h Server.h Client.h IThread.h Mutex.h SharedMemory.h GameEngine.h dimensions.h Ball.h
TARGET=pong
